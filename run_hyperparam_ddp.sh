...
GPU=$6 # pretrain gpu 개수
GPU_NUMBER="$5" # pretrain gpu 개수
...
LEARNING_RATE=$3 # grid search를 위해 파라미터를 추가해주세요! | ex : (1e-4 1e-6 1e-7 ...)
WARMUP_LR=$4 # grid search를 위해 파라미터를 추가해주세요! | ex : (1e-6 1e-7 1e-8 ...)
